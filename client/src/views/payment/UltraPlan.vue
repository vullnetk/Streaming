    ...
    <div>
        ...
        <div class="product">
            ...
            <div class="details-container">
                <h1>Ultra Plan</h1>
                <p class="description">Basic subscription with 4K Max Qality</p>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            lineItems: [
                {
                    price: 'price_1NIuouKQT0eVZi5g9gOgi7Tj', // The id of the recurring price you created in your Stripe dashboard
                    quantity: 1,
                },
